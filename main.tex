...
Bánh xe cố định là loại bánh xe đơn giản nhất, được gắn chặt vào khung robot với một hướng duy nhất không thể thay đổi.
Nó chỉ có một bậc tự do (Degree of Freedom) là quay quanh trục chính của nó \cite{mikova2016, leong2022, chung2008}.
...
Trong sơ đồ, vị trí của tâm bánh xe $A$ trên khung robot được xác định
bởi các thông số khoảng cách $l$ và góc $\alpha$.
