...
Cấu trúc dẫn động bánh cầu đại diện cho một bước tiến đột phá trong tư duy thiết kế robot di động: chuyển dịch từ sự ổn định tĩnh của các robot đa bánh truyền thống sang trạng thái cân bằng động trên một điểm tiếp xúc duy nhất. Đây là ví dụ điển hình nhất cho lớp hệ thống cơ điện tử thiếu dẫn động và không ổn định tự nhiên, đặt ra những thách thức lớn nhất nhưng cũng thú vị nhất cho lý thuyết điều khiển hiện đại \cite{lauwers2006}.

\subsubsection{Cấu hình cơ khí và nguyên lý truyền động}
Khác với bánh xe thông thường, quả cầu cần quay tự do theo mọi hướng (3 bậc tự do), do đó không thể gắn trục động cơ cố định trực tiếp vào tâm cầu. Thay vào đó, hệ thống sử dụng cơ chế truyền động gián tiếp thông qua ma sát bề mặt, thường được gọi là "Cơ cấu chuột bi ngược" (Inverse Mouse-ball Drive) \cite{lauwers2006}.
